    ...
    var json = {
        pages: [
                ...
                questions: [
                    {
                        ...
                        isRequired: true, choices: ["all|I ship all skins", "selected|I ship only a select number"], visibleIf: "{skinNumber} = 'many'"
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                questions: [
                    {
                        type: "text", name: "skinFavorite", title: "Do you have a personal favorite skin/theme?", visibleIf: "{skinNumber} = 'many'"
                    }
                ]
            },
            {
